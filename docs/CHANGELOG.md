...
## [21.0] 2026-05-11
- don't ask the server for `h264` `fast-decode` tuning: we always use a native decoder
...
- [handle video decoder failures](https://github.com/Xpra-org/xpra-html5/commit/8f653cdc6e3de342d4644e00445dfe0cb443b81c)
