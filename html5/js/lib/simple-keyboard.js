...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["SimpleKeyboard"] = factory();
...
*/
      ...
      /***/ 9714: /***/ function (
        ...
        var INCORRECT_NAME =
          PROPER_FUNCTION_NAME && n$ToString.name != TO_STRING;
    ...
    !(function () {
      ...
      var es_array_slice = __webpack_require__(7042); // CONCATENATED MODULE: ./src/lib/polyfills.js
      ...
      var web_dom_collections_iterator = __webpack_require__(3948); // CONCATENATED MODULE: ./src/lib/services/KeyboardLayout.ts
      ...
      var es_object_get_own_property_names = __webpack_require__(6210); // CONCATENATED MODULE: ./src/lib/services/Utilities.ts
      ...
      var Utilities = /*#__PURE__*/ (function () {
        ...
        function Utilities(_ref) {
          ...
          _defineProperty(this, "isStandardButton", function (button) {
            return (
              button &&
              !(button[0] === "{" && button[button.length - 1] === "}")
            );
          });
          ...
          [
            ...
            },
            {
              ...
              value: function getButtonClass(button) {
                ...
                var buttonWithoutBraces = button
                  .replace("{", "")
                  .replace("}", "");
            ...
            },
            {
              ...
              value: function getButtonDisplayName(
                button,
                display,
                mergeDisplay
              ) {
            ...
            },
            {
              ...
              value: function getUpdatedInput(button, input, caretPos) {
                ...
                if (
                  ...
                  output = this.removeAt.apply(
                    this,
                    [output].concat(commonParams)
                  );
                } else if (
                  (button === "{delete}" || button === "{forwarddelete}") &&
                  output.length > 0
                ) {
                  output = this.removeForwardsAt.apply(
                    this,
                    [output].concat(commonParams)
                  );
                } else if (button === "{space}")
                  output = this.addStringAt.apply(
                    this,
                    [output, " "].concat(commonParams)
                  );
                else if (
                  ...
                  output = this.addStringAt.apply(
                    this,
                    [output, button[button.length - 2]].concat(commonParams)
                  );
                  ...
                  output = this.addStringAt.apply(
                    this,
                    [output, button].concat(commonParams)
                  );
              ...
              value:
                ...
                function removeAt(source) {
                  ...
                  if (position === positionEnd) {
                    ...
                    output =
                      source.slice(0, position) + source.slice(positionEnd);
            ...
            },
            {
              ...
              value: function removeForwardsAt(source) {
                ...
                if (
                  !(source !== null && source !== void 0 && source.length) ||
                  position === null
                ) {
                  return source;
                }
                ...
                if (position === positionEnd) {
                  ...
                  if (emojiMatched) {
                    output =
                      source.substr(0, position) + source.substr(position + 2);
                  } else {
                    output =
                      source.substr(0, position) + source.substr(position + 1);
                  }
                } else {
                  output =
                    source.slice(0, position) + source.slice(positionEnd);
            ...
            },
            {
              ...
              value: function handleMaxLength(inputObj, updatedInput) {
                ...
                if (_typeof(maxLength) === "object") {
                  var _condition =
                    updatedInput.length - 1 >=
                    maxLength[options.inputName || "default"];
      ...
      /* harmony default export */ var services_Utilities = Utilities; // CONCATENATED MODULE: ./src/lib/services/PhysicalKeyboard.ts
      ...
      function PhysicalKeyboard_createClass(
        Constructor,
        protoProps,
        staticProps
      ) {
        ...
        PhysicalKeyboard_createClass(PhysicalKeyboard, [
          {
            ...
            value: function handleHighlightKeyDown(event) {
              ...
              this.dispatch(function (instance) {
                var standardButtonPressed =
                  instance.getButtonElement(buttonPressed);
                var functionButtonPressed = instance.getButtonElement(
          ...
          },
          {
            ...
            value: function handleHighlightKeyUp(event) {
              ...
              this.dispatch(function (instance) {
                var buttonDOM =
                  instance.getButtonElement(buttonPressed) ||
                  instance.getButtonElement("{".concat(buttonPressed, "}"));
          ...
          },
          {
            ...
            value: function getSimpleKeyboardLayoutKey(event) {
              ...
              var keyId =
                ...
                event.key ||
                this.keyCodeToKey(
                  event === null || event === void 0 ? void 0 : event.keyCode
                );
              ...
              if (
                ...
                (keyId !== null && keyId !== void 0 && keyId.includes("Alt")) ||
              ...
              return output.length > 1
                ? (_output = output) === null || _output === void 0
                  ? void 0
                  : _output.toLowerCase()
                : output;
            },
      ...
      /* harmony default export */ var services_PhysicalKeyboard =
        PhysicalKeyboard; // CONCATENATED MODULE: ./src/lib/components/CandidateBox.ts
      function CandidateBox_classCallCheck(instance, Constructor) {
        if (!(instance instanceof Constructor)) {
          throw new TypeError("Cannot call a class as a function");
        }
      }

      function CandidateBox_defineProperties(target, props) {
        for (var i = 0; i < props.length; i++) {
          var descriptor = props[i];
          descriptor.enumerable = descriptor.enumerable || false;
          descriptor.configurable = true;
      ...
      function CandidateBox_createClass(Constructor, protoProps, staticProps) {
        if (protoProps)
          CandidateBox_defineProperties(Constructor.prototype, protoProps);
        if (staticProps)
          CandidateBox_defineProperties(Constructor, staticProps);
        return Constructor;
      }

      function CandidateBox_defineProperty(obj, key, value) {
        if (key in obj) {
          Object.defineProperty(obj, key, {
            value: value,
            enumerable: true,
        ...
        CandidateBox_createClass(CandidateBox, [
          ...
          },
          {
            ...
            value: function renderPage(_ref3) {
              ...
              (_this$candidateBoxEle = this.candidateBoxElement) === null ||
              _this$candidateBoxEle === void 0
                ? void 0
                : _this$candidateBoxEle.remove(); // Create candidate box element
              ...
              candidateListPages[pageIndex].forEach(function (
                candidateListItem
              ) {
      ...
      /* harmony default export */ var components_CandidateBox = CandidateBox; // CONCATENATED MODULE: ./src/lib/components/Keyboard.ts
      function Keyboard_toConsumableArray(arr) {
        return (
          Keyboard_arrayWithoutHoles(arr) ||
          Keyboard_iterableToArray(arr) ||
          Keyboard_unsupportedIterableToArray(arr) ||
          Keyboard_nonIterableSpread()
        );
      }

      function Keyboard_nonIterableSpread() {
        throw new TypeError(
          "Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."
        );
      }

      function Keyboard_unsupportedIterableToArray(o, minLen) {
        if (!o) return;
        if (typeof o === "string") return Keyboard_arrayLikeToArray(o, minLen);
        var n = Object.prototype.toString.call(o).slice(8, -1);
        if (n === "Object" && o.constructor) n = o.constructor.name;
        if (n === "Map" || n === "Set") return Array.from(o);
        if (
      ...
      function Keyboard_iterableToArray(iter) {
        if (
          (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null) ||
          iter["@@iterator"] != null
        )
      ...
      function Keyboard_arrayWithoutHoles(arr) {
      ...
      function Keyboard_createClass(Constructor, protoProps, staticProps) {
        ...
        if (staticProps) Keyboard_defineProperties(Constructor, staticProps);
        return Constructor;
      }
      ...
      var SimpleKeyboard = /*#__PURE__*/ (function () {
        ...
        function SimpleKeyboard() {
          ...
          Keyboard_defineProperty(this, "getKeyboardClassString", function () {
            ...
            var keyboardClasses = [_this.keyboardDOMClass]
          ...
          for (
            var _len = arguments.length, _params = new Array(_len), _key = 0;
            _key < _len;
            _key++
          ) {
          ...
          var _this$handleParams = this.handleParams(_params),
            ...
            _options =
              _this$handleParams$op === void 0 ? {} : _this$handleParams$op;
          /**
          ...
          if (this.keyboardDOM) this.render();
            ...
            console.warn(
              '".'.concat(_keyboardDOMClass, '" was not found in the DOM.')
            );
        ...
        Keyboard_createClass(SimpleKeyboard, [
          ...
          },
          {
            ...
            value: function getInputCandidates(input) {
              ...
              if (
                !layoutCandidatesObj ||
                Keyboard_typeof(layoutCandidatesObj) !== "object"
              ) {
                return {};
              }

              var layoutCandidates = Object.keys(layoutCandidatesObj).filter(
                function (layoutCandidate) {
                  ...
                  var matches = Keyboard_toConsumableArray(
          ...
          },
          {
            ...
            value: function showCandidatesBox(
              candidateKey,
              candidateValue,
              targetElement
            ) {
              ...
              if (this.candidateBox) {
                this.candidateBox.show({
                  ...
                  onSelect: function onSelect(selectedCandidate, e) {
                    ...
                    if (typeof _this3.options.onChange === "function")
                      _this3.options.onChange(
                        _this3.getInput(_this3.options.inputName, true),
                        e
                      );
                    /**
                     * Calling onChangeAll
                    ...
                    if (typeof _this3.options.onChangeAll === "function")
                      _this3.options.onChangeAll(_this3.getAllInputs(), e);
                  },
                });
              }
            },
              ...
              if (
                ...
                if (
                  ...
                  if (candidateKey && candidateValue) {
                    ...
                    (_this$candidateBox = this.candidateBox) === null ||
                    _this$candidateBox === void 0
                      ? void 0
            ...
            value: function handleButtonMouseDown(button, e) {
              ...
              if (!this.options.disableButtonHold) {
                this.holdTimeout = window.setTimeout(function () {
                  if (
                    (_this4.isMouseHold && // TODO: This needs to be configurable through options
          ...
          },
          {
            ...
            value: function getInput() {
               ...
               * Enforce syncInstanceInputs, if set
               */
              if (this.options.syncInstanceInputs && !skipSync)
                this.syncInstanceInputs();

              if (this.options.rtl) {
                // Remove existing control chars
                var inputWithoutRTLControl = this.input[inputName]
                  .replace("\u202B", "")
                  .replace("\u202C", "");
          ...
          },
          {
            ...
            value: function setInput(input) {
              ...
              if (!skipSync && this.options.syncInstanceInputs)
                this.syncInstanceInputs();
            },
            /**
            ...
            value: function addButtonTheme(buttons, className) {
              ...
              buttons.split(" ").forEach(function (button) {
                className.split(" ").forEach(function (classNameItem) {
                  if (!_this10.options.buttonTheme)
            ...
            value: function removeButtonTheme(buttons, className) {
              ...
              if (
                ...
                buttonArray.forEach(function (button) {
                  ...
                  (_this11$options = _this11.options) === null ||
                  _this11$options === void 0
                    ? void 0
                    : (_this11$options$butto = _this11$options.buttonTheme) ===
                        null || _this11$options$butto === void 0
                    ? void 0
                    : _this11$options$butto.map(function (buttonTheme, index) {
                        /**
                        ...
                        if (
                          ...
                          var filteredButtonArray =
                            (_buttonTheme = buttonTheme) === null ||
                            _buttonTheme === void 0
                              ? void 0
                          ...
                          if (
                            buttonTheme &&
                            filteredButtonArray !== null &&
                            filteredButtonArray !== void 0 &&
                            ...
                            (_this11$options$butto2 =
                              _this11.options.buttonTheme) === null ||
                            _this11$options$butto2 === void 0
                              ? void 0
          ...
          },
          {
            ...
            value: function parseRowDOMContainers(
              rowDOM,
              rowIndex,
          ...
          },
          {
            ...
            value:
              ...
              function render() {
                ...
                var useTouchEventsClass = useTouchEvents
                  ? "hg-touch-events"
                  : "";
                var useMouseEvents = this.options.useMouseEvents || false;
                var disableRowButtonContainers =
                ...
                layout[this.options.layoutName || this.defaultName].forEach(
                  function (row, rIndex) {
                    ...
                    rowArray.forEach(function (button, bIndex) {
                       ...
                       */
                      var buttonHasContainerStart =
                        !disableRowButtonContainers &&
                        typeof button === "string" &&
                        button.length > 1 &&
                        button.indexOf("[") === 0;
                      var buttonHasContainerEnd =
                        !disableRowButtonContainers &&
                        typeof button === "string" &&
                        button.length > 1 &&
                      ...
                      var buttonType = _this16.options.useButtonTag
                        ? "button"
                        : "div";
                      ...
                      (_buttonDOM$classList = buttonDOM.classList).add.apply(
                      ...
                      if (!_this16.buttonElements[button])
      ...
      /* harmony default export */ var Keyboard = SimpleKeyboard; // CONCATENATED MODULE: ./src/lib/index.ts
