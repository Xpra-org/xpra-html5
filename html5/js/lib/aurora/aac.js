          ...
          var ADTSDemuxer = AV.Demuxer.extend(function () {
            ...
            this.prototype.readChunk = function () {
              if (!this.sentHeader) {
                ...
                cookie[0] =
                  (header.profile << 3) | ((header.samplingIndex >> 1) & 7);
                cookie[1] =
                  ((header.samplingIndex & 1) << 7) | (header.chanConfig << 3);
              ...
              while (this.stream.available(1)) {
                var buffer = this.stream.readSingleBuffer(
    ...
    2: [
      function (require, module, exports) {
        ...
        const CCE_SCALE = new Float32Array([
          1.09050773266525765921, 1.18920711500272106672,
          1.4142135623730950488016887, 2.0,
        ]);
        ...
        (function (global) {
          ...
          var AACDecoder = AV.Decoder.extend(function () {
            ...
            this.prototype.setCookie = function (buffer) {
              ...
              if (this.config.sampleIndex === 0x0f) {
                ...
                this.config.sampleRate =
                  tables.SAMPLE_RATES[this.config.sampleIndex];
              }
            ...
            this.prototype.readChunk = function () {
              ...
              if (stream.peek(12) === 0xfff) ADTSDemuxer.readHeader(stream);
            ...
            this.prototype.processSingle = function (element, channel) {
              ...
              if (element.tnsPresent) element.tns.process(element, data, false);
            ...
            this.prototype.applyChannelCoupling = function (
              element,
              couplingPoint,
              data1,
              data2
            ...
            for (var j = 0; j < length; j += shift) {
              for (var k = 0; k < i; k++) {
                var km = k * m,
                  ...
                  zRe =
                    input[i + j + k][0] * rootRe - input[i + j + k][1] * rootIm,
                  zIm =
                    input[i + j + k][0] * rootIm + input[i + j + k][1] * rootRe;
      ...
      function (require, module, exports) {
        ...
        ICStream.prototype = {
          decode: function (stream, config, commonWindow) {
            ...
            if (!commonWindow) this.info.decode(stream, config, commonWindow);
          ...
          decodeBandTypes: function (stream, config) {
            var bits =
                this.info.windowSequence === ICStream.EIGHT_SHORT_SEQUENCE
                  ? 3
                  : 5,
            ...
            for (var g = 0; g < groupCount; g++) {
              ...
              while (k < maxSFB) {
                ...
                if (bandType === 12) throw new Error("Invalid band type: 12");

                var incr;
                while ((incr = stream.read(bits)) === escape) end += incr;
                ...
                switch (bandTypes[idx]) {
                  ...
                  case ICStream.INTENSITY_BT2:
                    for (; i < runEnd; i++, idx++) {
                      ...
                      scaleFactors[idx] =
                        tables.SCALEFACTOR_TABLE[-tmp + SF_OFFSET];
                    }
                    break;
                  ...
                  default:
                    for (; i < runEnd; i++, idx++) {
                      ...
                      scaleFactors[idx] =
                        tables.SCALEFACTOR_TABLE[offset[0] - 100 + SF_OFFSET];
                    }
                    break;
                }
              }
                ...
                if (
                  ...
                  for (var group = 0; group < groupLen; group++, off += 128) {
                    ...
                    for (var k = 0; k < width; k++) {
                      this.randomState =
                        (this.randomState * (1664525 + 1013904223)) | 0;
    ...
    11: [
      function (require, module, exports) {
        ...
        const SWB_OFFSET_1024_96 = new Uint16Array([
          ...
          88, 96, 108, 120, 132, 144, 156, 172, 188, 212, 240, 276, 320, 384,
        ...
        const SWB_OFFSET_1024_64 = new Uint16Array([
          0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 64, 72, 80,
          88, 100, 112, 124, 140, 156, 172, 192, 216, 240, 268, 304, 344, 384,
          424, 464, 504, 544, 584, 624, 664, 704, 744, 784, 824, 864, 904, 944,
          984, 1024,
        ]);
        ...
        const SWB_OFFSET_1024_48 = new Uint16Array([
          ...
          108, 120, 132, 144, 160, 176, 196, 216, 240, 264, 292, 320, 352, 384,
        ...
        const SWB_OFFSET_1024_32 = new Uint16Array([
          ...
          108, 120, 132, 144, 160, 176, 196, 216, 240, 264, 292, 320, 352, 384,
          416, 448, 480, 512, 544, 576, 608, 640, 672, 704, 736, 768, 800, 832,
          864, 896, 928, 960, 992, 1024,
        ]);

        const SWB_OFFSET_1024_24 = new Uint16Array([
          0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 52, 60, 68, 76, 84, 92,
          100, 108, 116, 124, 136, 148, 160, 172, 188, 204, 220, 240, 260, 284,
          308, 336, 364, 396, 432, 468, 508, 552, 600, 652, 704, 768, 832, 896,
          960, 1024,
        ]);
    ...
    12: [
      function (require, module, exports) {
        ...
        const TNS_COEF_1_3 = [0.0, -0.43388373, 0.64278758, 0.34202015],
          TNS_COEF_0_3 = [
            0.0, -0.43388373, -0.7818315, -0.9749279, 0.98480773, 0.86602539,
            0.64278758, 0.34202015,
          ],
          TNS_COEF_1_4 = [
            0.0, -0.2079117, -0.40673664, -0.58778524, 0.67369562, 0.52643216,
            0.36124167, 0.18374951,
          ],
          TNS_COEF_0_4 = [
            0.0, -0.2079117, -0.40673664, -0.58778524, -0.74314481, -0.86602539,
            -0.95105654, -0.99452192, 0.99573416, 0.96182561, 0.8951633,
            0.7980172, 0.67369562, 0.52643216, 0.36124167, 0.18374951,
          ],
